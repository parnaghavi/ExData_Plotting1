...
12  
13 # open device 
14 png(filename='plots/plot2.png',width=480,height=480,units='px') 
15  
16 # plot data 
17 plot(power.consumption$DateTime,power.consumption$GlobalActivePower,ylab='Global Active Power (kilowatts)', xlab='', type='l') 
18  
19 # close device 
